...
// const _kDateCount   = 7;   // số ngày hiển thị từ hôm nay
...
//     setState(() { _isRefreshing = true; _detailError = null; });
//     try {
//       final fresh = await FieldService.instance.getFieldDetail(_field!.fieldId);
//       if (!mounted) return;
//       setState(() { _field = fresh; _isRefreshing = false; });
//     } catch (e) {
//       if (!mounted) return;
//       setState(() { _detailError = e.toString(); _isRefreshing = false; });
//     }
//   }

//   Future<void> _loadSlots() async {
//     if (_field == null) return;
//     setState(() { _isLoadingSlots = true; _slotError = null; _selectedSlotIds.clear(); });
//     try {
...
//       );
//       if (!mounted) return;
//       // API trả list sân — lấy đúng sân của màn hình này
//       final match = schedules.where((s) => s.fieldId == _field!.fieldId).firstOrNull;
//       setState(() {
//         _slots = match?.slots ?? [];
...
//     } catch (e) {
//       if (!mounted) return;
//       setState(() { _slotError = e.toString(); _isLoadingSlots = false; });
//     }
//   }

//   Future<void> _loadReviews() async {
//     if (_field == null) return;
//     setState(() { _isLoadingReviews = true; _reviewError = null; });
//     try {
//       final summary = await ReviewService.instance.getFieldReviews(_field!.fieldId);
//       if (!mounted) return;
//       setState(() { _reviewSummary = summary; _isLoadingReviews = false; });
//     } catch (e) {
//       if (!mounted) return;
//       setState(() { _reviewError = e.toString(); _isLoadingReviews = false; });
//     }
//   }
...
//         .where((s) => _selectedSlotIds.contains(s.fieldSlotId))
//         .toList();
//     context.push('/fields/booking_confirm', extra: {
//       'field': _field,
//       'date':  _selectedDate,
//       'slots': selectedSlots,
//     });
...
//           onRefresh: () async { await _refreshDetail(); await _loadSlots(); await _loadReviews(); },
//           child: ListView(
//             children: [
...
//                             size: 10, color: AppColors.warningOrange),
//                       Text(
...
//   Widget build(BuildContext context) {
//     return Padding(
//       padding: const EdgeInsets.fromLTRB(AppSpacing.pagePadH, 12, AppSpacing.pagePadH, 0),
//       child: Wrap(
//         spacing: 16,
//         runSpacing: 6,
//         children: const [
...
//   Widget build(BuildContext context) {
//     return Padding(
//       padding: const EdgeInsets.symmetric(vertical: 20, horizontal: AppSpacing.pagePadH),
//       child: Column(
//         children: [
//           const Text(
...
//     child: Row(
//       children: [
//         const Icon(Icons.warning_amber_rounded, color: AppColors.warningOrange, size: 18),
//         const SizedBox(width: 8),
//         Expanded(
//           child: Text(
//             message,
...
//   final IconData icon;
//   final bool isPeak;
//   const _PriceItem({required this.label, required this.value, required this.icon, this.isPeak = false});
...
//           Text('$value/giờ', style: TextStyle(color: color, fontWeight: FontWeight.w800, fontSize: 16)),
//           const SizedBox(height: 2),
...
//               review.comment!,
//               style: const TextStyle(
//                 color: AppColors.textMid, fontSize: 13.5, height: 1.5,
//               ),
//             ),
//           ],
...
//     padding: EdgeInsets.symmetric(vertical: 20, horizontal: AppSpacing.pagePadH),
//     child: Center(
//       child: Text(
