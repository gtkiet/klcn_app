...
//
// extra: { 'booking': BookingModel, 'payUrl'?: String }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SpOutlineButton(
                        ...
                        onTap: () => context.go('/booking_history'),
                      ),
                    ],
                  ),
                ),
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: _ReceiptInfo(label: 'NGÀY', value: booking.primaryDate),
                ),
                Expanded(
                  child: _ReceiptInfo(label: 'KHUNG GIỜ', value: booking.primaryTime),
                ),
              ],
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: AppColors.primaryUltraLight, shape: BoxShape.circle,
      ),
      child: Center(
        child: Container(
          width: 96, height: 96,
