...
abstract class AppText {
  ...
  static const hintText = TextStyle(color: AppColors.textHint, fontSize: 15);

  static const bodyMid = TextStyle(color: AppColors.textMid, fontSize: 14);

  static const errorStyle = TextStyle(color: AppColors.errorRed, fontSize: 12);
...
abstract class AppShadow {
  ...
  static const btn = [
    BoxShadow(color: Color(0x402E7D32), blurRadius: 14, offset: Offset(0, 5)),
  ];
}
